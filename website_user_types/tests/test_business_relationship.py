...
class TestBusinessRelationship(BusinessRelationshipsTestUsers):
    def test_default_website_user_group(self):
        ...
        self.assertEqual(self.business_relationship_b2b.website_user_group_id, group_b2b)
        self.assertEqual(self.business_relationship_b2c.website_user_group_id, group_b2c)
        self.assertEqual(self.business_relationship_internal.website_user_group_id, group_b2c)
