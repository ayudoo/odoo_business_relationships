...
class WebsiteSaleShipping(WebsiteSale):
    ...
    def confirm_order(self, **post):
        ...
        if partner.business_relationship_id.sale_order_pricelist == 'shipping':
            ...
            if (
                order.partner_id != order.partner_shipping_id and
                order.partner_id.property_product_pricelist != order.partner_shipping_id.property_product_pricelist
            ):
                ...
                request.website.sale_get_order(update_pricelist=True, force_pricelist=order.pricelist_id.id)
